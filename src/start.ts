...
import { clearTerminal, getTerminalUI, instanceTerminal } from "./component/terminal.ui.js";
...
import { setBackground } from "./service/ui.service.js";
...
async function start() {
  document.body.style.transition = "background:var(--animation-slow)";
  setBackground();
  setCommands();
